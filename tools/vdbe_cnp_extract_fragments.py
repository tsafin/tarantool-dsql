...
PILOT_FRAGMENTS = [
    ...
    {"name": "OP_DecrJumpZero", "kind_num": 2, "tail_fallthrough": False},
    {"name": "OP_SetDiag", "kind_num": 2, "tail_fallthrough": False},
    {"name": "OP_Noop", "kind_num": 1, "tail_fallthrough": False},
    {"name": "OP_Eq", "kind_num": 2, "tail_fallthrough": False},
    {"name": "OP_Ge", "kind_num": 2, "tail_fallthrough": False},
    {"name": "OP_MustBeInt", "kind_num": 2, "tail_fallthrough": False},
    {"name": "OP_MakeRecord", "kind_num": 1, "tail_fallthrough": False},
    # sort_window coroutine / sorter opcodes
    {"name": "OP_InitCoroutine", "kind_num": 1, "tail_fallthrough": False},
    {"name": "OP_Yield", "kind_num": 1, "tail_fallthrough": False},
    {"name": "OP_EndCoroutine", "kind_num": 1, "tail_fallthrough": False},
    {"name": "OP_SorterOpen", "kind_num": 1, "tail_fallthrough": False},
