...
/* Note: When included into vdbe.c, vdbe_ops.h is already included,
 * so we skip the generated header to avoid redeclaration conflicts.
 * The function prototypes are already in scope from vdbe_ops.h.
 */
#ifndef VDBE_OPS_H
